...
class Item
  ...
  def initialize(row, item_repo)
    ...
    @unit_price = BigDecimal.new(row[:unit_price]) #/ 100 #added hundred due to spec harness require, still waiting for Beth to let us know whether it is correct or not.
